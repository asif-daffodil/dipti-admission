...
<body>
    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-md-6 d-flex flex-column justify-content-between gap-3 mb-5 mb-lg-0">
                <h1>Boost Up Your Career in IT & Animation Sector</h1>
                <h2>Online Registration Form</h2>
                <p class="text-bg-danger px-2">Class will be held through Own campus and Online Education Platform</p>
                <form action="{{ route('leads.store') }}" method="post">
                    @csrf
                    {{-- fullname --}}
                    <div class="mb-3">
                        <label for="fullname" class="form-label">Full Name</label>
                        <input type="text" class="form-control {{ $errors->has('fullname') ? 'is-invalid' : '' }}" id="fullname" name="fullname">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" id="mobile" name="mobile">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select {{ $errors->has('course_id') ? 'is-invalid' : '' }}" id="course" name="course_id">
            ...
            <div class="col-md-6 d-flex flex-column gap-3">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.788488994773!2d90.37379437402683!3d23.75492078860524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b92533c3528f%3A0xe6b8c0e0676b8089!2sDaffodil%20International%20Professional%20Training%20Institute%20(DIPTI).!5e0!3m2!1sen!2sbd!4v1748722208225!5m2!1sen!2sbd"
                    style="border:0; width: 100%; max-width: 560px; min-height: 315px;" allowfullscreen=""
