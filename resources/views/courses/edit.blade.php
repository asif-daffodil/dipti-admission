                    ...
                    <form method="POST" action="{{ route('courses.update', $course->id) }}">
                        ...
                        <div class="mb-4 flex items-center space-x-0">
                            <div class="flex-1">
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $course->title) }}" required class="block w-full border-gray-300 rounded-l-md rounded-r-none shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-10 {{ $errors->has('title') ? 'border-red-500' : '' }}">
